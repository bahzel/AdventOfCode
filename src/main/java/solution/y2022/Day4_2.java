...
public class Day4_2 extends InstructionSolution<Pair<Pair<Integer, Integer>, Pair<Integer, Integer>>, AtomicInteger> {
	...
	protected boolean performInstruction(Pair<Pair<Integer, Integer>, Pair<Integer, Integer>> pairPairPair,
		...
		if (pairPairPair.getLeft().getLeft() >= pairPairPair.getRight().getLeft()
				&& pairPairPair.getLeft().getLeft() <= pairPairPair.getRight().getRight()
				|| pairPairPair.getLeft().getRight() >= pairPairPair.getRight().getLeft()
						&& pairPairPair.getLeft().getRight() <= pairPairPair.getRight().getRight()
				|| pairPairPair.getRight().getLeft() >= pairPairPair.getLeft().getLeft()
						&& pairPairPair.getRight().getLeft() <= pairPairPair.getLeft().getRight()
				|| pairPairPair.getRight().getRight() >= pairPairPair.getLeft().getLeft()
