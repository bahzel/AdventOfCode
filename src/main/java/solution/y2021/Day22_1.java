...
public class Day22_1 extends InstructionSolution<Cube, List<Cube>> {
	...
	protected boolean performInstruction(Cube cube, List<Cube> cubes) {
		if (cube.getMinX() > 50 || cube.getMaxX() < -50 || cube.getMinY() > 50 || cube.getMaxY() < -50
				|| cube.getMinZ() > 50 || cube.getMaxZ() < -50) {
			return false;
		}
