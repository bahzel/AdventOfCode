...
public class Day23_1 extends
		MapSolution<List<Triple<BiConsumer<Map<String, Integer>, AtomicInteger>, BiConsumer<Map<String, Integer>, AtomicInteger>, AtomicBoolean>>> {
	...
	protected void transformInstruction(String instruction,
			List<Triple<BiConsumer<Map<String, Integer>, AtomicInteger>, BiConsumer<Map<String, Integer>, AtomicInteger>, AtomicBoolean>> consumers) {
		var instructions = instruction.split(" ");
		switch (instructions[0]) {
		case "cpy":
			consumers.add(Triple.of(cpy(instructions[1], instructions[2]), jnz(instructions[0], instructions[1]),
		...
		case "dec":
			...
			break;
		case "jnz":
			consumers.add(Triple.of(jnz(instructions[1], instructions[2]), cpy(instructions[1], instructions[2]),
					new AtomicBoolean(true)));
			break;
		case "tgl":
	...
	private BiConsumer<Map<String, Integer>, AtomicInteger> tgl(String param,
			List<Triple<BiConsumer<Map<String, Integer>, AtomicInteger>, BiConsumer<Map<String, Integer>, AtomicInteger>, AtomicBoolean>> consumers) {
		if (NumberUtils.isParsable(param)) {
