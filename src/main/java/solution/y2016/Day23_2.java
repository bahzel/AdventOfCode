...
public class Day23_2 extends MapSolution<List<Triple<BiConsumer<Map<String, Integer>, AtomicInteger>, BiConsumer<Map<String, Integer>, AtomicInteger>, AtomicBoolean>>> {
