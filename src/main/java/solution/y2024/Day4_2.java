...
public class Day4_2 extends Solution {
		...
		for (var x = 0; x < wordSearch.length; x++) {
			for (var y = 0; y < wordSearch[x].length; y++) {
				for (var direction : directions) {
					if (getCharAt(wordSearch, x, y, direction.getFirst()) == 'M'
							...
							&& getCharAt(wordSearch, x, y, direction.get(4)) == 'S') {
						counter++;
					}
				}
			}
	...
	private List<List<Point>> getDirections() {
		...
		directions.add(List.of(new Point(0, 0), new Point(0, 2), new Point(1, 1), new Point(2, 0), new Point(2, 2)));
		directions.add(List.of(new Point(0, 0), new Point(2, 0), new Point(1, 1), new Point(0, 2), new Point(2, 2)));
		directions.add(List.of(new Point(2, 0), new Point(2, 2), new Point(1, 1), new Point(0, 2), new Point(0, 0)));
		directions.add(List.of(new Point(2, 2), new Point(0, 2), new Point(1, 1), new Point(0, 0), new Point(2, 0)));
